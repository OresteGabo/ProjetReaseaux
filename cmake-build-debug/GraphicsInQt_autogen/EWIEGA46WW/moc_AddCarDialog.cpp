...
QT_MOC_LITERAL(5, 33, 5), // "speed"
QT_MOC_LITERAL(6, 39, 9), // "frequency"
QT_MOC_LITERAL(7, 49, 10), // "onValidate"
QT_MOC_LITERAL(8, 60, 8), // "onCancel"
QT_MOC_LITERAL(9, 69, 14) // "onGeneratePath"

    },
    "AddCarDialog\0carAdded\0\0Path\0path\0speed\0"
    "frequency\0onValidate\0onCancel\0"
    "onGeneratePath"
};
...
void AddCarDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->carAdded((*reinterpret_cast< const Path(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            using _t = void (AddCarDialog::*)(const Path & , int , int );
...
// SIGNAL 0
void AddCarDialog::carAdded(const Path & _t1, int _t2, int _t3)
{
