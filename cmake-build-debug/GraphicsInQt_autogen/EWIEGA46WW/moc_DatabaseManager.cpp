...
QT_MOC_LITERAL(1, 16, 17), // "parseDataFinished"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 7) // "success"

    },
    "DatabaseManager\0parseDataFinished\0\0"
    "success"
};
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->parseDataFinished((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::parseDataFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DatabaseManager::parseDataFinished(bool _t1)
{
